<?php
namespace Order\FrontController\Model\ResourceModel;

use Order\FrontController\Api\Data;
use Order\FrontController\Api\FrontRepositoryInterface;
use Magento\Framework\Reflection\DataObjectProcessor;
use Magento\Framework\Api\DataObjectHelper;
use Order\FrontController\Model\ResourceModel\Front\CollectionFactory as FrontCollectionFactory;
use Magento\Framework\Api\SortOrder;
use Order\FrontController\Model\ResourceModel\Front as FrontResource;
...
class FrontRepository implements FrontRepositoryInterface
{
     ...
     */
    public function save(\Order\FrontController\Api\Data\FrontInterface $front)
    {
        try {
     ...
     * @return \Order\FrontController\Api\Data\FrontSearchResultInterface
     * @throws \Magento\Framework\Exception\LocalizedException
     */
     ...
     * Get Front data
     *
     * @param \Order\FrontController\Model\ResourceModel\Front\Collection $collection
     * @return array[]
     */
    private function getFrontData(
        \Order\FrontController\Model\ResourceModel\Front\Collection $collection
    ) {
        $front = [];
